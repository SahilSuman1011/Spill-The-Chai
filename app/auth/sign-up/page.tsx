                 ...
                 <FieldGroup className="gap-y-4">
                    ...
                    name="name" control={form.control} render={({field, fieldState}) => (
                        <Field>
                            ...
                            <Input aria-invalid={fieldState.invalid} placeholder="Tyler Durden" {...field}/>
                            {fieldState.invalid && (
                    ...
                    name="email" control={form.control} render={({field, fieldState}) => (
                        <Field>
                            ...
                            <Input aria-invalid={fieldState.invalid} placeholder="tylerdurden@fightclub.com" type="email" {...field}/>
                            {fieldState.invalid && (
                                <FieldError errors={[fieldState.error]}/>
                            )}
                        </Field>
